...
{
    /**
     * Shows difference between each of a list of golf scores and their
     * average.
     */
    public static void main(String[] args)
    {
        ...
        System.out.println("how much each differs form the average.");
    ...
    public static double computeAverage(ArrayList<Double> a)
    {
        ...
        for (Double element : a)
            ...
            {
                System.out.println("EFFOR: Trying to average 0 numbers.");
                System.out.println("computeAverage returns 0.");
                return 0;
            }
    }
    /**
     * Gives screem output showing how much each of the elements
